...
set_property IOSTANDARD LVCMOS33 [get_ports but6]
set_property IOSTANDARD LVCMOS33 [get_ports but7]
set_property IOSTANDARD LVCMOS33 [get_ports but8]
set_property PACKAGE_PIN R1 [get_ports but1]
set_property PACKAGE_PIN N4 [get_ports but2]
set_property PACKAGE_PIN M4 [get_ports but3]
set_property PACKAGE_PIN R2 [get_ports but4]
set_property PACKAGE_PIN P2 [get_ports but5]
set_property PACKAGE_PIN P3 [get_ports but6]
set_property PACKAGE_PIN P4 [get_ports but7]
set_property PACKAGE_PIN P5 [get_ports but8]
...
set_property PACKAGE_PIN V1 [get_ports rst0]
set_property PACKAGE_PIN R15 [get_ports sel0]
